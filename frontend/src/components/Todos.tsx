...
export class Todos extends React.PureComponent<TodosProps, TodosState> {
    ...
    onTodoCreate = async () => {
        try {
            ...
            } else if (this.state.newTodoDescription.length === 0) {
                alert('Todo creation failed. Please input {Task Description}')
            } else {
                                ...
                                <Card.Content>
                                    ...
                                    <Card.Meta>
                                        <Button.Group>
                                            ...
                                            />
                                            <Popup
                                                trigger={<Button active={todo.status === 1} inverted color='blue' onClick={() => this.onTodoStatus(pos, 1)}>
                                                    <Icon name="sync"/>
                                                </Button>
                                                }
                                                content='in process'
